...
const palavras = {
  ...
  medio: [{
      palavra: 'família',
      dica: 'É de sangue mas nem sempre estão juntos...'
    },
    {
      palavra: 'cultura',
      dica: 'Faz parte da sociedade...'
    },
    {
      palavra: 'sucesso',
      dica: 'O que todos querem mas poucos conseguem...'
    },
  ],
  dificil: [{
      palavra: 'hipócrita',
      dica: 'É quem diz ser mas não é...'
    },
    {
      palavra: 'vagabundo',
      dica: 'Aquele que não cumpre com suas obrigações é...'
    },
    {
      palavra: 'esperança',
      dica: 'Em Star Wars temos uma nova...'
    },
  ],
};
